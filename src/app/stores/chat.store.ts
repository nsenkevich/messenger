...
export const useChatStore = createInjectable(() => {
  ...
  async function sendImageMessage(chatId: string, senderId: string, file: any) {
  ...
  async function createNewChat(participantEmail: string) {
    ...
    const existingChatQuery = query(
      ...
      where('participants', 'array-contains-any', [currentUser.uid, participantUser.uid])
    );
